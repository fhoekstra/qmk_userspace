...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_EXT] = LAYOUT_split_3x6_3(
        ...
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
            OS_GUI , OS_ALT , OS_SHFT, OS_CTRL, OS_RALT,                      KC_LEFT, KC_DOWN,  KC_UP ,KC_RIGHT, KC_DELX,
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
            XXXXXXX, XXXXXXX, XXXXXXX, KC_ESC, XXXXXXX,                      XXXXXXX, KC_BSPC, KC_HOME, KC_END , KC_PSCR,
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
    ...
    [_FUNC] = LAYOUT_split_3x6_3( // SYM + EXT
        ...
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
            OS_GUI , OS_ALT , OS_SHFT, OS_CTRL, RM_TOGG,                       BRTUP ,  KC_F1 ,  KC_F2 ,  KC_F3 , KC_F11 ,
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
             MUTE  , XXXXXXX, MYSCOPY,MYSPASTE, RM_NEXT,                       BRTDN ,  KC_F4 ,  KC_F5 ,  KC_F6 , KC_F12 ,
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                       _______, _______, _______,   _______ , KC_ENT , _______
                                   //`--------------------------'  `--------------------------'
        ),
    ...
    [_NUM] = LAYOUT_split_3x6_3(
        //,--------------------------------------------.                    ,--------------------------------------------.
            AS_TAB , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_INS ,  KC_7  ,  KC_8  ,  KC_9  , XXXXXXX,
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
            OS_GUI , OS_ALT , OS_SHFT, OS_CTRL, OS_RALT,                       KC_0  ,  KC_1  ,  KC_2  ,  KC_3  , KC_DEL ,
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
             A_TAB , CS_TAB ,  C_TAB , XXXXXXX, XXXXXXX,                      KC_END ,  KC_4  ,  KC_5  ,  KC_6  , KC_PSCR,
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                       _______, _______, _______,   _______ , KC_ENT , _______
                                   //`--------------------------'  `--------------------------'
        ),
