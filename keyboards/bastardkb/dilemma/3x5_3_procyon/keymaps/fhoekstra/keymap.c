...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT_split_3x5_3(
        //,--------------------------------------------.                    ,--------------------------------------------.
            KC_TILD, KC_PLUS, KC_EQL , KC_LCBR, KC_PERC,                      KC_AMPR, KC_RCBR, KC_ASTR, KC_EXLM,  KC_AT ,
        //|----*---+----*---+---*----+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
        ...
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                       _______, _______, _______,    LA_SHRT, KC_SPC , _______
                                   //`--------------------------'  `--------------------------'
        ),
    ...
    [_NUM] = LAYOUT_split_3x5_3(
        ...
        //|----*---+----*---+----*---+---**---+--------|                    |--------+---**---+---*----+---*----+---*----|
            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_0  ,  KC_1  ,  KC_2  ,  KC_3  , KC_SLSH,
        //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                       _______, _______, _______,    KC_ENT , KC_SPC , _______
                                   //`--------------------------'  `--------------------------'
        ),
...
#define DILEMMA_MINIMUM_SNIPING_DPI 400
